...
class installer::prerequisites (Hash $archs) {
  ...
  file { [ '/robotx',
           '/robotx/toolchain',
           '/robotx/toolchain/bin',
           '/robotx/toolchain/include',
           '/robotx/toolchain/src' ]:
    ensure => directory,
  }

  # Make the architecture specific directories.
  $archs.each |String $arch, Hash $params| {
    file { [ "/robotx/toolchain/${arch}",
             "/robotx/toolchain/${arch}/bin",
             "/robotx/toolchain/${arch}/include",
             "/robotx/toolchain/${arch}/lib",
             "/robotx/toolchain/${arch}/man",
             "/robotx/toolchain/${arch}/share",
             "/robotx/toolchain/${arch}/src" ]:
      ensure => directory,
    }
  }
}
