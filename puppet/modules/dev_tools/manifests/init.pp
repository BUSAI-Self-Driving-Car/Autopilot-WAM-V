class dev_tools {
  ...
  # Ensure that zsh language is set to avoid graphical errors
  file_line{ 'zshrc_lang': path => '/home/vagrant/.zshrc', line => 'export LANG="en_US.UTF-8"'}
  ...
  package { 'protobuf': ensure => installed, provider => 'pip' }
  ...
  file { '/robotx/toolchain/find_robot_hosts.sh':
    ensure => present,
    mode => '755',
